...
var client = require("@sanity/client"), stegaEncodeSourceMap = require("./_chunks-cjs/stegaEncodeSourceMap.cjs"), vercelStegaCleanAll = require("./_chunks-cjs/vercelStegaCleanAll.cjs");
...
exports.vercelStegaCleanAll = vercelStegaCleanAll.vercelStegaCleanAll;
